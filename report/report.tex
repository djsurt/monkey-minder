...
\textbf{Transparency}:
Clients interact with the system as if it were a single, reliable ZooKeeper-like service with a heirarchical
namespace. They are unaware of which node is currently the leader, when failovers occur, or how many replicas
