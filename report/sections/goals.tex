...
Zab and Raft are both equivalent to Paxos \cite{wang_parallels_2019, junqueira_barriers_2015}, Raft is more recent algorithm
and used in popular services such as etcd and MongoDB used in popular services such as etcd and MongoDB \cite{etcd_raft, zhou_mongodb_2021}. Additionally, 
...
independent serialization framework \cite{protobuf_google}. We chose these tools due to their
