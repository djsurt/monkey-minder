...
under failure scenarios. For instance, Kim et al.~\cite{kim_improved_2021} explored improving leader-based
...
networks and churn failures. Finally, Paznikov et al.~\cite{paznikov_implementation_2020} proposes a leaderless approach
...
such as Sui et al.~\cite{sui_signature-free_2025}, which demonstrates that atomic broadcast can be achieved efficiently
through a reduction from multivalued Byzantine Agreement (MBA) while avoiding heavy
cryptographic signatures, and from Mane et al.~\cite{mane_verify_2023} which proposes additions to
