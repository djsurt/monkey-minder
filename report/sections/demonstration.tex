...
The remaining figures demonstrate the successful use of each of our service APIs. \ref{fig:SetData}
demonstrates setting the value of a znode, which requires leader forwarding. \ref{fig:Get Updated}
verifies that the updated value is read by the client. \ref{fig:Delete} demonstrates that znodes
...
\easyfigure{screenshots/Get_Updated.png}{\label{fig:Get Updated}Reading the updated value}
