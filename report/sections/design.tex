...
gRPC server state, a replicated log, and separate channels for AppendEntries and RequestVote RPC messages.
...
This enables easy integration with our hierarchical tree data store.
...
The state machine that is replicated by Raft is a hierarchical \texttt{Tree} structure that closely
...
state always reflects committed, majority-replicated updates.
